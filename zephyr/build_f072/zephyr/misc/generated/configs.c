...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CAPSTONE_GRIPPER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CAPSTONE_HOPPER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CAPSTONE_MECANUM_MOTORS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_F072RB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_F072RB_STM32F072XB, 1);
